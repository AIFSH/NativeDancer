...
def pre_check() -> bool:
	if not nativedancer.globals.skip_download:
		download_directory_path = resolve_relative_path('../weights/face_enhancer')
...
def enhance_face(target_face: Face, temp_frame: Frame) -> Frame:
	...
	paste_frame = paste_back(temp_frame, crop_frame, affine_matrix, nativedancer.globals.face_mask_blur, (0, 0, 0, 0))
