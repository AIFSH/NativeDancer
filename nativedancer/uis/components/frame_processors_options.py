...
from nativedancer.processors.frame.typings import FaceSwapperModel, FaceEnhancerModel, FrameEnhancerModel, FaceDebuggerItem
...
def render() -> None:
	...
	FRAME_ENHANCER_MODEL_DROPDOWN = gradio.Dropdown(
		label = helperdoc.get('frame_enhancer_model_dropdown_label'),
		choices = frame_processors_choices.frame_enhancer_models,
		value = frame_processors_globals.frame_enhancer_model,
		visible = 'frame_enhancer' in nativedancer.globals.frame_processors
	)
	FRAME_ENHANCER_BLEND_SLIDER = gradio.Slider(
		label = helperdoc.get('frame_enhancer_blend_slider_label'),
	...
	FACE_DEBUGGER_ITEMS_CHECKBOX_GROUP = gradio.CheckboxGroup(
		label = helperdoc.get('face_debugger_items_checkbox_group_label'),
		choices = frame_processors_choices.face_debugger_items,
		value = frame_processors_globals.face_debugger_items,
		visible = 'face_debugger' in nativedancer.globals.frame_processors
	)
