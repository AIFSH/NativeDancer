...
from nativedancer.utils import update_status
class MagicAnimate():
    def __init__(self, config="nativedancer/third_part/magicanimate/configs/prompts/animation.yaml") -> None:
        update_status("Initializing MagicAnimate Pipeline...","MagicAnimate")
    ...
    def __call__(self, source_image, motion_sequence, output_file,fps,random_seed, step, guidance_scale, size=512):
            prompt = n_prompt = ""
            ...
            save_videos_grid(samples_per_video, output_file,fps=fps)
