...
from nativedancer.third_part.detectron2.data import DatasetCatalog, MetadataCatalog
from nativedancer.third_part.detectron2.data.datasets.lvis import get_lvis_instances_meta
