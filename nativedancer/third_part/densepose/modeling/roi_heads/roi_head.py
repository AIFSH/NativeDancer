...
from nativedancer.third_part.detectron2.layers import Conv2d, ShapeSpec, get_norm
from nativedancer.third_part.detectron2.modeling import ROI_HEADS_REGISTRY, StandardROIHeads
from nativedancer.third_part.detectron2.modeling.poolers import ROIPooler
from nativedancer.third_part.detectron2.modeling.roi_heads import select_foreground_proposals
from nativedancer.third_part.detectron2.structures import ImageList, Instances
